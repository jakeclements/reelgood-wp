...
/*-----------------------------------------------------------------------------------*/
	...
	function form( $instance ) {
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'catname' ); ?>"><?php _e('Category:', 'zilla') ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'catname' ); ?>" name="<?php echo $this->get_field_name( 'catname' ); ?>" value="<?php echo $instance['catname']; ?>" />
		</p>
