...
/*-----------------------------------------------------------------------------------*/
	...
	if ( have_comments() ) :
        ...
        if ( ! empty($comments_by_type['comment']) ) : // if there are normal comments ?>
	        ...
	        <h3 class="comments-title"><?php comments_number(__('No Comments', 'zilla'), __('One Comment', 'zilla'), __('% Comments', 'zilla')); ?></h3>
        ...
        if ( ! empty($comments_by_type['pings']) ) : // if there are pings ?>
			...
			<div class="pings-wrapper">
	    		<h3 class="pings-title"><?php _e('Trackbacks', 'zilla') ?></h3>
...
/*-----------------------------------------------------------------------------------*/
	...
	if ( comments_open() ) : ?>
	    ...
	    $fields = array(
            ...
            'title_reply_to' => __('Reply to %s', 'zilla'),
